---
name: update-readme
description: Use when unitmux user-facing behavior changes, including shortcuts, settings, UI controls, app workflows, install instructions, README updates, docs sync requests, or changed visible behavior.
---
