...
下段左下には、選択中ペインのトークン使用量（合計、入力、出力、キャッシュヒット率）が表示されます。ペイン切り替え、詳細表示、プロンプト送信後に更新されます。
...
`Ctrl+D` で選択中のペインの詳細を表示：ターゲット、コマンド、モデル、セッションID、トークン使用量の内訳、PID、CWD、gitブランチ/ステータス。詳細パネルには**セッション終了**ボタンがあり、ペインを閉じることができます。詳細パネル表示中に `Ctrl+C` を押すと、確認ダイアログが表示されます。
...
- **Token Usage** — ローカルの Claude Code / Codex ログ全体の合計、入力、出力、キャッシュ入力、reasoning、キャッシュヒット率を確認
